...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { circle_id: @invite.circle_id, code: @invite.code, num: @invite.num, user_id: @invite.user_id }
    end
  ...
  test "should update invite" do
    patch :update, id: @invite, invite: { circle_id: @invite.circle_id, code: @invite.code, num: @invite.num, user_id: @invite.user_id }
    assert_redirected_to invite_path(assigns(:invite))
  end
